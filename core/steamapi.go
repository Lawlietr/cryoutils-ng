...
// AppResponse is the JSON structure returned by the Steam GetAppList API.
...
// QuerySteamAPI queries the Steam GetAppList API.
func (e *Engine) QuerySteamAPI() (AppResponse, error) {
...
// GenerateGameMap creates a map[appid]name from a Steam API response.
