...
// Green UI Color.
var Green = struct{ R, G, B, A uint8 }{R: 0, G: 155, B: 0, A: 255}

// Gray UI Color.
var Gray = struct{ R, G, B, A uint8 }{R: 155, G: 155, B: 155, A: 255}

// Red UI Color.
var Red = struct{ R, G, B, A uint8 }{R: 255, G: 0, B: 0, A: 255}

// White UI Color.
var White = struct{ R, G, B, A uint8 }{R: 255, G: 255, B: 255, A: 255}
...
// ExternalDataRoot The location where compatdata and shadercache are kept on microSD cards.
...
// SteamApiUrl The URL for the Steam GetAppList API.
